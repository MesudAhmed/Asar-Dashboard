...
const { data: adminDataRequests, refresh: refreshAdminRequestsData, pending } = useAdminRequests()

const adminRequests = computed(() => adminDataRequests.value as teamsResponse | undefined)
</script>
